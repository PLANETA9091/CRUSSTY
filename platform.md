...
- [Bricks in JavaScript](./creating/javascript/bricks.html)
- [Bricks in Python](./creating/python/bricks.html)
- [Bricks in C / C++](./creating/c/bricks.html)
- [Bricks in Rust](./creating/rust/bricks.html)

## Internals

How each brick is implemented (brick files, events/telemetry/signals usage
inside the runtime) is on [Platform internals](./runtime-platform.html).